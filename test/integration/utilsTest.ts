...
describe("Test: utils", function () {
    it("replaceRoomIdsWithPills correctly turns a room ID in to a pill", async function () {
        ...
        const managementRoomOutput: ManagementRoomOutput =
            this.mjolnir.managementRoomOutput;
        ...
        assert.equal(
            ...
            `it's fun here in <a href="https://matrix.to/#/${encodeURIComponent(
                managementRoomAlias,
            )}">${managementRoomAlias}</a>`,
        );
    });
});
